...
<!DOCTYPE html><html lang="en" dir="">
        ...
        <div class="d-tabel-cell form_sec align-middle ">	
            ...
            <div class="login_logo">
                ...
                <div class="form_inner_div">
                    <div class="title">Login to Your Admin Account/ IF Are you trainer pleaes go <a href="/trainer/login">Let's GO</a></div>
    ...
    <input type="text" name="admin_email" id="email" value="" class="form-control required email" placeholder="@example.com">
...
@enderror 
                     ...
                     <div class="form-elements">
                        <label>Password</label><div class="pull-right"> </div>
                           <div class=" form-group ">
    <input type="password" name="admin_password" id="password" value="" class="form-control  required" autocomplete="off" placeholder="**********">
